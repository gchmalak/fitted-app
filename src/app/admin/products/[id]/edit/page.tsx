...
function EditProductForm() {
  ...
  useEffect(() => {
    if (product) {
      ...
      form.setFieldValue("department", product.department);
      form.setFieldValue("categoryId", product.categoryId?._id ?? "");
      form.setFieldValue("subcategory", product.subcategory ?? "");
  ...
  return (
    ...
    >
      ...
      {isMutateError && <p className="text-sm text-gold">{error.message}</p>}
